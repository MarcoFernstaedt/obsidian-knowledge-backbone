...
1. Retrieve a small set of relevant exact lexical citations. Every call creates a complete internally consistent point-in-time scan of approved source and uses only a private in-memory FTS database; authoritative notes may change afterward.
